...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(myMethod(generateRandomAge(),16));
        System.out.println(myMethod(generateRandomAge(),-19));
        System.out.println(myMethod(generateRandomAge(),2));
...
/* Создать возвращаемый метод который будет принимать 2 входящих параметра - возраст человека и температуру на улице,
